...
import { Brain, Cpu, Zap, Database, Users, Sparkles, Network, Lock, Bot, Globe, Shield, Code } from "lucide-react"

interface AiTechnologyCardProps {
  title: string
  description: string
  icon: string
  delay?: number
...
const AiTechnologyCard = ({ title, description, icon, delay = 0 }: AiTechnologyCardProps) => {
