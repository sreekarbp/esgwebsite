...
import { ArrowRight, Cpu, Network, Braces, Database, Server, Cloud, Shield } from "lucide-react"
import { Button } from "@/components/ui/button"

export default function TechInnovationWall() {
  ...
  const technologies = [
    {
      ...
      description: "Advanced algorithms and neural networks that learn from your data to deliver predictive insights.",
      color: "from-blue-600 to-cyan-400",
    },
    {
      icon: <Network className="h-6 w-6" />,
      title: "Neural Networks",
      description: "Deep learning architectures that mimic human brain function to solve complex business problems.",
    ...
    },
    {
      ...
      description: "Process data closer to the source for faster insights and reduced latency.",
      color: "from-red-600 to-pink-400",
    },
    {
      icon: <Cloud className="h-6 w-6" />,
      title: "Cloud Infrastructure",
      description: "Secure, scalable cloud platforms that provide the foundation for your digital transformation.",
      color: "from-blue-600 to-indigo-400",
    },
    {
      icon: <Shield className="h-6 w-6" />,
      title: "Cybersecurity",
      description: "Advanced protection for your critical systems and data against evolving threats.",
